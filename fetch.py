#!/usr/bin/env python3
"""
Recupero codici sconto eScarpe da shopilo.it
Sursa: https://shopilo.it/negozi/escarpe.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/escarpe.it"
STORE_NAME = "eScarpe"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per eScarpe da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-escarpe)"
    }
    try:
